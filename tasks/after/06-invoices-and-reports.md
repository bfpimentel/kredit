...
### Backend
- **Gemini Integration**: Added `google-generativeai` to process PDF invoices and extract spending data.
...
- **Auth Logic**: Automatically creates default categories for new users upon first login.

### Frontend
- **Dashboard**: Added charts (Bar & Pie) to visualize spendings by category.
